          ...
          children: <Widget>[
            ...
            new Container(
              ...
              child: new IconButton(
                  icon: new Icon(Icons.send,color: Color(0xFF00796B),),
  ...
  List<Widget> otherMessage(context) {
    return <Widget>[
      new Container(
        ...
        child: new CircleAvatar(child: FaIcon(FontAwesomeIcons.robot),backgroundColor: Color(0xFF00796B),),
      ),
      new Expanded(
        child: new Column(
  ...
  List<Widget> myMessage(context) {
    return <Widget>[
      ...
      new Container(
        ...
        child: new CircleAvatar(child: new Text(this.name[0],style: TextStyle(color: Colors.white),),backgroundColor: Color(0xFF00796B),),
      ),
    ];
  }
