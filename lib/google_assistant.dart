import 'package:medico/widgets/basicCard.dart';
import 'package:medico/widgets/carouselSelect.dart';
import 'package:medico/widgets/simple_message.dart';
...
class _GoogleAssistant extends State<GoogleAssistant> {
  ...
  void Response(query) async {
    ...
    await AuthGoogle(fileJson: "assets/medichat-aeqmeh-83eba599121f.json").build();
